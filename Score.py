...
class SCORE:
    ...
    def placar1(self,plac_1,tela):
        ...
        self.score_text_rect.center = (470, 50)
        self.score_text = self.score_font.render(str(plac_1), True, "blue", "brown")
    ...
    def placar2(self,plac_2,tela):
        ...
        self.score_text_rect = self.score_text.get_rect()
        self.score_text_rect.center = (520, 50)
        self.score_text = self.score_font.render(str(plac_2), True, "green", "brown")
        self.ret = tela.blit(self.score_text, self.score_text_rect)
        return self.ret
